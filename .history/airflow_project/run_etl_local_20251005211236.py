...
class LocalETLRunner:
    ...
    def create_consommation_iris_table(self, population, consommation, iris, city):
        ...
        # Standardiser les types des colonnes de jointure
        population['ID_Personne'] = population['ID_Personne'].astype(str)
        consommation['ID_Adr'] = consommation['ID_Adr'].astype(str)
        iris['ID_Rue'] = iris['ID_Rue'].astype(str)
