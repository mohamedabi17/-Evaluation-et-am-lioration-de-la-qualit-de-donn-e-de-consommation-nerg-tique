    ...
    def improve_completeness(self, df: pd.DataFrame, strategies: Dict) -> pd.DataFrame:
        ...
        for column, strategy in strategies.items():
            ...
            if strategy == 'mean':
                ...
                df_improved.loc[:, column] = df_improved[column].fillna(fill_value)
                ...
                df_improved.loc[:, column] = df_improved[column].fillna(method='ffill')
...
def create_improvement_config_consommation():
    ...
    return {
        ...
        'codification_rules': {
            # Pas de règles de codification pour les données de consommation
        },
        'business_rules': [
            {
